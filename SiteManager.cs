// -----------------------------------------------------------------------------
// <copyright file="SiteManager.cs" company="genuine">
...
namespace Constellation.Sitecore.SiteManagement
{
    ...
    public class SiteManager
    {
        ...
        public SiteRemovalTransaction RemoveSite(string siteBlueprintName, string siteName)
        {
            ...
            var folderSettings = SiteManagementConfigurationSection.Instance.SiteBlueprints[siteBlueprintName].SystemFolders;

            transaction.Log.AppendLine("Removing site: " + siteName);

            try
            {
                foreach (SystemFolderConfigurationElement setting in folderSettings)
                {
                    // delete folders.
        ...
        {
            var folderSettings = SiteManagementConfigurationSection.Instance.SiteBlueprints[settings.SiteBlueprintName].SystemFolders;
        ...
        {
            var folderSettings = SiteManagementConfigurationSection.Instance.SiteBlueprints[transaction.Settings.SiteBlueprintName].SystemFolders;
        ...
        private IEnumerable<string> GenerateSiteConfigs(SiteCreationTransaction transaction)
        {
            ...
            var targetSystems = SiteManagementConfigurationSection.Instance.TargetSystems;
