...
namespace Constellation.Sitecore.SiteManagement
{
	...
	public class NewSiteSettings
	{
		...
		public NewSiteSettings([NotNull] string siteName, [NotNull] string siteBlueprintName, [NotNull] string siteType, [NotNull] string virtualFolderName, [NotNull] ID defaultLanguageID, [NotNull] IEnumerable<ID> additionalLanguages)
		{
