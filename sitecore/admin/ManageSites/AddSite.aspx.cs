// -----------------------------------------------------------------------------
// <copyright file="AddSite.aspx.cs" company="genuine">
...
namespace Constellation.Sitecore.SiteManagement.UI
{
    ...
    public partial class AddSite : SiteManagementBasePage
    {
        ...
        {
            var settings = SiteManagementConfigurationSection.Instance.SiteBlueprints;

            foreach (SiteBlueprintConfigurationElement setting in settings)
            {
